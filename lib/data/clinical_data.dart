// Класи моделей інтегровані прямо сюди для надійності збірки
...
class ClinicalData {
  ...
  static final List<ClinicalScale> allScales = [
    ClinicalScale(
      id: "ims", 
      name: "Шкала мобільності ВІТ (IMS)", 
      icfCategory: "d450 Рухливість", 
      instruction: "Оцінка реального рівня мобільності пацієнта від 0 (лежачий) до 10 (самостійна ходьба).", 
    ...
    ClinicalScale(
      id: "mrc", 
      name: "Шкала м'язової сили (MRC-SumScore)", 
      icfCategory: "b730 Сила м'язів", 
      instruction: "Тестування 6 м'язових груп з обох сторін. Максимум 60 балів. Менше 48 — синдром ICUAW.", 
      testType: "single_choice", 
      questions: [
    ...
    ClinicalScale(
      id: "vas", 
      name: "Візуально-аналогова шкала болю (VAS)", 
      icfCategory: "b280 Відчуття болю", 
      instruction: "Оцінка інтенсивності болю пацієнтом від 0 (немає болю) до 10 (нестерпний біль).", 
      testType: "single_choice", 
      questions: [
